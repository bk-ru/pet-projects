...
| --- | --- | --- | --- | --- |
| [Auth API / 2025](https://github.com/bk-ru/auth_api) | API аутентификация и авторизация пользователей. | FastAPI-бэкенд с JWT-аутентификацией и RBAC-ролями. Реализованы регистрация, вход, профиль, выход, мягкое удаление и административное API для управления ролями и правами. | FastAPI, SQLAlchemy, Pydantic, Passlib, PyJWT, PostgreSQL / SQLite | |
| [bkdetect / 2025](https://github.com/bk-ru/bkdetect) | Библиотека для поиска источников и совпадающих фрагментов текста. | Библиотека для анализа текстовых коллекций, определения схожих документов и выделения совпадающих фрагментов. Поддерживает .txt, .csv, .docx, .html, потоковую индексацию и предобработку текста (NLTK). Опубликована на PyPI. | Python, scikit-learn, NLTK, BeautifulSoup, TF-IDF, cosine similarity | |
...
| [Machine Learning Zoomcamp / 2025](./mlzoomcamp) | 4-месячный курс по основам машинного обучения | В процесессе обучения: линейная и логистическая регрессия, метрики классификации, ансамбли (Random Forest, XGBoost), нейросети (TensorFlow, PyTorch), деплой моделей через FastAPI, Docker и Kubernetes. | scikit-learn, FastAPI, Docker, TensorFlow, PyTorch, XGBoost  | [>Подробнее<](https://github.com/DataTalksClub/machine-learning-zoomcamp) |
| [ML training Yandex / 2025](./yandex-ml-4) | ML тренировки Яндекса | Изучены механизмы внимания (Attention: additive, multiplicative, dot-product) в NumPy, свёрточная нейросеть для FashionMNIST, а также методы обучения с подкреплением - Crossentropy Method, Q-Learning, SARSA, Policy Gradient в средах Gymnasium. | NumPy, PyTorch, Gymnasium, Attention  | [>Подробнее<](https://yandex.ru/yaintern/training) |
