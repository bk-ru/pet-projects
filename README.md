...
| --- | --- | --- | --- | --- |
| [Auth API / 2025]([https://github.com/bk-ru/bkdetect](https://github.com/bk-ru/auth_api)) | Библиотека для поиска источников и совпадающих фрагментов текста. | Библиотека на Python для анализа текстовых коллекций, определения схожих документов и выделения совпадающих фрагментов. Поддерживает .txt, .csv, .docx, .html, 
| [bkdetect / 2025](https://github.com/bk-ru/bkdetect) | API аутентификации и авторизации пользователей. | FastAPI-бэкенд с JWT-аутентификацией и RBAC-ролями. Реализованы регистрация, вход, профиль, выход, мягкое удаление и административное API для управления ролями и правами. | FastAPI, SQLAlchemy, Pydantic, Passlib, PyJWT, PostgreSQL / SQLite | |
