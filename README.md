...
| [Discord Bot / 2025](https://github.com/bk-ru/discord_bot) | Discord bot | Discord-бот для сервера виртуальной кафедры. Облегчает процесс отправки студенческих работ, и проверки их со стороны преподавателей | Python, discord.py, Tortoise ORM, SQLite, Pandas | |
